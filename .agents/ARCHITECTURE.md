...
- **12 Rules** — workspace routing, coding, design, safety, and quick-reference constraints (includes 6 SQL/RDBMS-specific rules);
...
├── rules/                    # 12 workspace constraints (6 base + 6 SQL-specific)
...
| **Total Skills**    | 52 (47 base + 5 SQL/RDBMS bridge)  |
| **Total Workflows** | 18 (13 base + 5 SQL-adapted)       |
