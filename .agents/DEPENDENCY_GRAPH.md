...
Kit version: `2026.8.31` · 20 agents · 52 skills · 18 workflows
...
flowchart LR
  ...
  W_bugfix --> A_debugger
  W_bugfix -.-> S_systematic_debugging
  W_bugfix -.-> S_bugfix
  ...
  W_diagnose --> A_debugger
  W_diagnose -.-> S_diagnose
  W_diagnose -.-> S_systematic_debugging
  W_diff_review --> A_security_auditor
  W_diff_review -.-> S_diff_review
  W_diff_review -.-> S_code_review_checklist
  W_enhance --> A_code_archaeologist
  W_enhance -.-> S_simplify_code
  W_enhance -.-> S_clean_code
  W_enhance -.-> S_verify_changes
  W_feature --> A_backend_specialist
  W_feature -.-> S_feature
  W_feature -.-> S_plan_writing
  ...
  W_refactor --> A_code_archaeologist
  W_refactor -.-> S_refactor
  W_refactor -.-> S_clean_code
